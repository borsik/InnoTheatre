<?php
	...
	$query = "SELECT per.per_name, p.play_date, p.play_time, p.grade, p.price
				FROM Play p, Theater t, Performance per
				WHERE p.tid = t.tid 
				AND per.per_id = p.per_id
				AND t.name = 'Bolshoi Theatre'";
